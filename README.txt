This website is a collection of code and files taken from various free sources and modified in ways to make it into a legally usable website for a currently NPO. Even if the department begins charging for its services, the code and assets used on this website have been used in a transitive manner and can be considered legal under fair use laws. 
